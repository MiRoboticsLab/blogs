...
| 关节名称 | 关节范围[rad] | 最大速度[m/s] | 最大力矩[Nm] | 关节名称 | 关节范围[rad] | 最大速度[m/s] | 最大力矩[Nm] |
| ------ | ------- | ------- | ------- | ------ | ------- | ------- | ------- |
...
```
### 2.4 接口示例
本节编写了高层接口的3个例程以供参考，例程可以部署在用户电脑或者NX应用板上运行。如果部署在用户电脑，需要按照1.2节所介绍的步骤，安装LCM通信库。所有例程都可以在[例程仓库](https://github.com/MiRoboticsLab/loco_hl_example)下载。
